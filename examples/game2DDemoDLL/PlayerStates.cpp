 ...
 * 
 */
void PlayerStateIdle::Execute(IController *pController_, GameTime elpasedTime_)
{
	PlayerController *pPlayerController = dynamic_cast<PlayerController *>(pController_);
 ...
 * 
 */
void PlayerStateAttack::Execute(IController *pController_, GameTime elpasedTime_)
{
	PlayerController *pPlayerController = dynamic_cast<PlayerController *>(pController_);
