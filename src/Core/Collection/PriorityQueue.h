...
namespace CasaEngine
{
	...
	template<class T>
	class PriorityQ :
		public AllocatedObject<PriorityQ>
	{
	private:
	...
	public:
	  ...
	  void insert(const T item)
	  {
		...
		CA_ASSERT(m_iSize+1 <= m_iMaxSize, "PriorityQ::insert");
	...
	template<class T>
	class PriorityQLow :
		public AllocatedObject<PriorityQLow>
	{
	private:
	...
	public:
	  ...
	  void insert(const T item)
	  {
		CA_ASSERT(m_iSize+1 <= m_iMaxSize, "PriorityQLow::insert()");
	...
	class IndexedPriorityQLow :
		public AllocatedObject<IndexedPriorityQLow>
	{
	private:
	...
	public:
	  ...
	  {
		CA_ASSERT(m_iSize+1 <= m_iMaxSize, "IndexedPriorityQLow::insert()");
