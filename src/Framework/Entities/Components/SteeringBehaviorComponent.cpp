...
#include  "Maths/2D/Geometry.hpp"
#include  "Maths/2D/Line2D.hpp"
#include  "Maths/2D/Transformations.hpp"
...
namespace CasaEngine
{
	...
	void SteeringBehaviorComponent::Update(const GameTime& gameTime_)
	{
		...
		GetEntity()->GetCoordinates().SetLocalPosition(Vector3(m_Position2D.x, GetEntity()->GetCoordinates().GetPosition().y, m_Position2D.y));
	}
